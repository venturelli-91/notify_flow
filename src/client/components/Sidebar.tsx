...
export function Sidebar() {
	...
	return (
		<aside className="w-52 flex-shrink-0 bg-white rounded-2xl shadow-sm flex flex-col py-8 px-4 self-start sticky top-5 max-sm:hidden">
			{/* Logo */}
				...
				{navItems.map(({ label, href, Icon, exact, disabled }) => {
					...
					if (disabled) {
						return (
							<span
								key={label}
								className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-[13px] text-gray-400 cursor-default select-none">
